      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工资待遇" prop="gongzidaiyu">
          <el-input v-model="ruleForm.gongzidaiyu" 
              placeholder="工资待遇" clearable  :readonly="ro.gongzidaiyu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工资待遇" prop="gongzidaiyu">
              <el-input v-model="ruleForm.gongzidaiyu" 
                placeholder="工资待遇" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.zhaopinshijian = this.getCurDate()
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zhiyuanzhezhaopin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhiyuanzhezhaopinCrossAddOrUpdateFlag = false;
                  this.parent.search();
